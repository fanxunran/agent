export default {
   ...
   */
  parseBarOrLineData(sourceData, x, y, z, fixXAxisData, sortLegendData, sortXConfig = { sortBy: undefined }) {
    const dataMap = {};
   ...
   */
  parseScatterOrLineData(sourceData, x, y, z, w) {
    const seriesData = [];
    seriesData[0] = {
      data: []
    };
    sourceData.forEach(item => {
      let list = [item[x] * 100, item[y] * 100, item[z], item[w]];
